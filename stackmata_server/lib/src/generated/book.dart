...
abstract class Book extends _i1.TableRow {
  ...
  Map<String, dynamic> allToJson() {
    return {
      ...
      'clientBookAuthors':
          clientBookAuthors.toJson(valueToJson: (v) => v.allToJson()),
      'publisher': publisher,
      'summary': summary,
      if (language != null)
        'language': language?.toJson(valueToJson: (v) => v.allToJson()),
      'clientLanguages':
          clientLanguages.toJson(valueToJson: (v) => v.allToJson()),
      if (series != null)
        'series': series?.toJson(valueToJson: (v) => v.allToJson()),
      'clientSeries': clientSeries.toJson(valueToJson: (v) => v.allToJson()),
      if (awards != null)
        'awards': awards?.toJson(valueToJson: (v) => v.allToJson()),
      'clientAwards': clientAwards.toJson(valueToJson: (v) => v.allToJson()),
      if (genres != null)
        'genres': genres?.toJson(valueToJson: (v) => v.allToJson()),
      'clientGenres': clientGenres.toJson(valueToJson: (v) => v.allToJson()),
      'source': source,
      'entryDate': entryDate.toJson(),
      if (formats != null)
        'formats': formats?.toJson(valueToJson: (v) => v.allToJson()),
      'clientFormats': clientFormats.toJson(valueToJson: (v) => v.allToJson()),
      'numberOfCopies': numberOfCopies,
      if (callNumbers != null)
